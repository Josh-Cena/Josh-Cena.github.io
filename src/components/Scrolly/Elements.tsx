...
function ScrollyElements({
  ...
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox={`-100 0 400 ${superTall ? 1000 : 200}`} className={clsx(styles.elements)} preserveAspectRatio="xMinYMin slice">
      <g
      ...
      <g opacity={borderOpacity} transform={`matrix(1, 0, 0, 1, 0, ${borderShiftY})`}>
        <path
        ...
        <path
          ...
          strokeWidth={5}
          className={styles.nameBorder}
          d="M 10,30 L 190,30 L 190,170 L 10,170 Z"
        />
      </g>
    </svg>
  );
