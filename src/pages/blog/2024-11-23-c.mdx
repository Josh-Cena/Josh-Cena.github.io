---
description: Please, make C die in a fire 🔥
---

# In search of a good programming language: C
...
[^1]: In 2026, I can add "forcing students to write code without AI" to this list (I will probably write a [separate piece](./2025-03-26-ai-usage.mdx) on this topic).
