...
1. I enumerate all prefixes of length up to 21 characters as function A. The prefix must end at a comma. (e.g., `R,8,L,12,R,8`)
2. I split the sequence by A into non-empty segments. (e.g., `["R,12,L,8,R,10,R,12,L,8,R,10,", "R,8,L,8,L,8,R,8,R,10,", "R,8,L,8,L,8,R,8,R,10,R,12,L,8,R,10,R,8,L,8,L,8,R,8,R,10,"]`)
3. For the first segment, I enumerate all prefixes of length up to 21 characters as function B. Again, the prefix must end at a comma. (e.g., `R,12,L,8,`)
4. I split all segments by B into non-empty segments. (e.g., `["R,10,", "R,10,", "R,8,L,8,L,8,R,8,R,10,", "R,8,L,8,L,8,R,8,R,10,", "R,10,R,8,L,8,L,8,R,8,R,10,"]`)
