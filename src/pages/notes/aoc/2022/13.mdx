...
This input reminds me of [2021 day 18](../2021/18.mdx), where we also had to parse a nested list structure. The difference is that this time I am using Haskell, and I do want strong types, so no `Data.Aeson`; manual parsing it is.
