...
This kind of reminds me of [2020 day 23](../2020/23.mdx), where we also have to turn things around a circular list, which I implemented as a linked list. This problem needs to implement similar operations. In pseudocode it looks like:
