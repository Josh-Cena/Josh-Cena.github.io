...
This is very similar to [day 16](./16.mdx). We also want to explore a decision space and maximize the output, where the score of each decision is dependent on how early we made it. Let's start by defining the states of our space.
