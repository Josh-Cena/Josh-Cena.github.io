...
![Intermediate junction graph](./23-intermediate.png)
...
![Final junction graph](https://github.com/Josh-Cena/aoc2023/blob/master/src/day23_1.png?raw=true)
