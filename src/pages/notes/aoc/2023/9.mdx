---
description: "Advent of Code 2023 - Day 9: Mirage Maintenance. Written in R."
tags:
  - Mathematics
year: 2023
day: 9
...
# AoC 2023 D9: Mirage Maintenance
...
It seems that every year there's always a problem where I cheat; for example [2020 day 18](/notes/aoc/2020/18) is done with Python's built-in `ast` module. For this one, we are just fitting the data to a polynomial, so I just use `lm`. Language choice rewards solutions :)
