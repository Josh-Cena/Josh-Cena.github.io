...
<table>
  ...
  <tbody>
    <tr>
      <th>∅-</th>
      <td>1 "into the house through the front door"<br />[kchiki]</td>
      <td></td>
      <td>8 "into a hole"<br />[ktaqalhwaxni]</td>
      <td>9 "out of a hole"<br />[ktaqalhwaxni]</td>
    </tr>
    <tr>
      <th>[akpu:-]</th>
      <td>3 "into the house through a hole in the roof"<br />[n chiki]</td>
      <td></td>
      <td></td>
      <td>2 "out of the chimney"<br />[n chiki]</td>
    </tr>
    <tr>
      <th>[cha:qe:-]</th>
      <td></td>
      <td>4 "out the back door"<br />[n chiki]</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      ...
      <td></td>
      <td></td>
      <td>5 "into a flower box on the side of the house"<br />[n chiki]</td>
      <td></td>
    </tr>
    <tr>
      <th>[tampi:-]</th>
      <td>6 "under the house"<br />[n chiki]</td>
      <td>7 "out from under the house"<br />[n chiki]</td>
      <td></td>
      <td></td>
    </tr>
  </tbody>
