...
`,e.jsxs(n.p,{children:["Once we have the compressed grid, we just need to walk the wire again, this time counting steps. For each wire, I keep a ",e.jsx(n.code,{children:"map<pair<int, int>, int>"})," that maps each (row, column) to the number of steps taken to reach that cell. We sum the two maps by key and find the minimum."]}),e.jsx(i,{frontMatter:s})]})}function l(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{l as default,s as frontMatter};
