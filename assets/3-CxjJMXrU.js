...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ocaml",children:`let _, total =
  List.fold_left
    ...
    (true, 0) matches
`})}),`
`,e.jsx(i,{frontMatter:r})]})}function d(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{d as default,r as frontMatter};
