import{u as r,j as e}from"./index-DyI1T4xN.js";import{P as i,a as o}from"./_components-YM4q2yub.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Ciqn2WuZ.js";const n={tags:["Morphology","Semantics"],title:"NACLO 2025 - Problem J: Nganasan Idol",description:"NACLO 2025 - Problem J: Nganasan Idol, a problem that involves Morphology and Semantics. Detailed solution and walkthrough.",year:2025,prob:"J"};function t(s){const a={br:"br",h1:"h1",li:"li",p:"p",span:"span",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(a.h1,{children:["NACLO 2025 - Problem J",e.jsx(a.span,{className:"subtitle",children:"Nganasan Idol"})]}),e.jsx(i,{frontMatter:n}),`
`,`
...
`,e.jsx(a.p,{children:'There are a lot of little pitfalls here. For example remember to pluralize "trees" in J4, or remember that pluralization is irregular for both parts of J3.'}),e.jsx(o,{frontMatter:n})]})}function u(s={}){const{wrapper:a}={...r(),...s.components};return a?e.jsx(a,{...s,children:e.jsx(t,{...s})}):t(s)}export{u as default,n as frontMatter};
