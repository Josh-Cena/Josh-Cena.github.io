import{u as i,j as e}from"./index-CKqa2xZ3.js";import{P as r,a as o}from"./_components-Ci0FrSUn.js";import"./_commonjsHelpers-CqkleIqs.js";const h="/assets/day12-chat-B7UQH992.png",n={tags:["Puzzle"],title:"Advent of Code 2025 - Day 12: Christmas Tree Farm",description:"Advent of Code 2025 - Day 12: Christmas Tree Farm, a problem that involves Puzzle. Solution written in Rust, with detailed walkthrough and proof.",year:2025,day:12};function a(s){const t={code:"code",h1:"h1",img:"img",p:"p",pre:"pre",span:"span",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.h1,{children:["Advent of Code 2025 - Day 12",e.jsx(t.span,{className:"subtitle",children:"Christmas Tree Farm"})]}),e.jsx(r,{frontMatter:n}),`
...
`,e.jsx(t.p,{children:"Anyway, I'm extremely underwhelmed by this meme problem on the last day. I get that problems are usually easy on the last day, but it used to be Christmas day when everyone was busy, and now it's just the 12th and everyone's supposed to be having fun. I was amused but also bummed."}),e.jsx(o,{frontMatter:n})]})}function p(s={}){const{wrapper:t}={...i(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(a,{...s})}):a(s)}export{p as default,n as frontMatter};
