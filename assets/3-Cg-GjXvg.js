...
`,e.jsxs(n.p,{children:["Now I have a list of ",e.jsx(n.code,{children:"*"})," locations and the numbers next to them. I just need to sum the products for the pairs of numbers."]}),e.jsx(i,{frontMatter:s})]})}function c(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{c as default,s as frontMatter};
