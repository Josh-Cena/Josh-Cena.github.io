import{u as c,j as e}from"./index-DwRXtLVn.js";import{C as l}from"./index-DP-BdsL9.js";import{P as p,a as x}from"./_components-C1hTrXOn.js";import"./_commonjsHelpers-Cpj98o6Y.js";const g="/assets/23-intermediate-vDXHvd8a.png",r={tags:["Maze","Graph theory","BFS/DFS","Manual inspection"],title:"Advent of Code 2023 - Day 23: A Long Walk",description:"Advent of Code 2023 - Day 23: A Long Walk, a problem that involves Maze, Graph theory, BFS/DFS, and Manual inspection. Solution written in R, with detailed walkthrough and proof.",year:2023,day:23};function h(t){const s={a:"a",annotation:"annotation",code:"code",em:"em",h1:"h1",h2:"h2",img:"img",li:"li",math:"math",mfrac:"mfrac",mi:"mi",mn:"mn",mo:"mo",mrow:"mrow",mtext:"mtext",munder:"munder",ol:"ol",p:"p",path:"path",pre:"pre",semantics:"semantics",span:"span",svg:"svg",...c(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.h1,{children:["Advent of Code 2023 - Day 23",e.jsx(s.span,{className:"subtitle",children:"A Long Walk"})]}),e.jsx(p,{frontMatter:r}),`
...
`,e.jsx(s.p,{children:e.jsx(s.img,{src:g,alt:"Intermediate junction graph",width:2419,height:3258})}),`
...
`,e.jsx(s.p,{children:e.jsx(s.img,{src:"https://github.com/Josh-Cena/aoc2023/blob/master/src/day23_1.png?raw=true",alt:"Final junction graph"})}),`
...
`,e.jsx(s.p,{children:e.jsx(s.img,{src:"https://github.com/Josh-Cena/aoc2023/blob/master/src/day23_2.png?raw=true",alt:"Final junction graph, undirected"})}),`
