import{j as s,u as i,C as m}from"./index-MRNusryy.js";import{C as d}from"./index-BuHOtiTj.js";const h="/assets/yale-logo-CzvkiTv6.png";function o({code:n}){return s.jsx("pre",{className:"mermaid",children:n})}const x=`---
...
`,s.jsx(d,{code:(l,t,r,c)=>{l.fillStyle="#39cac4",l.fillRect(10,10,t-20,r-20),l.fillStyle=c,l.font="20px sans-serif",l.fillText("Text works!",20,100)},width:200,height:200}),`
...
`]}),`
`]}),`
`]})]})}function y(n={}){const{wrapper:e}={...i(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(a,{...n})}):a(n)}export{y as default,u as frontMatter};
