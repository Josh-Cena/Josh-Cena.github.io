import{u as i,j as e}from"./index-BVdbyz0p.js";import{F as r,a as o}from"./_components-ozm2G8yB.js";const h="/assets/day12-chat-B7UQH992.png",n={tags:["Puzzle"],description:"Advent of Code 2025 - Day 12: Christmas Tree Farm, a problem that involves Puzzle. Solution written in Rust, with detailed walkthrough and proof.",year:2025,day:12,title:"Advent of Code 2025 - Day 12: Christmas Tree Farm"};function a(s){const t={code:"code",h1:"h1",p:"p",pre:"pre",span:"span",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.h1,{children:["Advent of Code 2025 - Day 12",e.jsx(t.span,{className:"subtitle",children:"Christmas Tree Farm"})]}),`
`,`
`,e.jsx(r,{frontMatter:n}),`
`,e.jsx(t.p,{children:"An all-time classic:"}),`
`,`
`,`
`,e.jsx("img",{alt:`Josh-Cena in Discord: "Grrr, it's tetris all over again"; half an hour later: "YOU CAN'T BE SERIOUS" "OK this year I successfully wasted... checks notes... 3 hours of my life doing pointless things in AoC"`,src:h,width:1530,height:310,style:{maxWidth:"100%",height:"auto"}}),`
...
`,e.jsx(o,{frontMatter:n})]})}function c(s={}){const{wrapper:t}={...i(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(a,{...s})}):a(s)}export{c as default,n as frontMatter};
