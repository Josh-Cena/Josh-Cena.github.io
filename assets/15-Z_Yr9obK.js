...
...
`})}),`
`,e.jsxs(n.p,{children:["Because whenever we are trying to move a half-box (",e.jsx(n.code,{children:"mat.(nr).(nc) = ']'"})," or ",e.jsx(n.code,{children:"mat.(nr).(nc) = '['"}),"), we always move the accompanying half-box as well, the final result is guaranteed to have the two halves together."]}),e.jsx(d,{frontMatter:o})]})}function h(t={}){const{wrapper:n}={...c(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{h as default,o as frontMatter};
