...
`,s.jsx(t,{code:(a,d,h,p,j)=>{a.fillStyle="#39CAC480",a.beginPath(),a.moveTo(1*40,1*40),a.lineTo(8*40,1*40),a.lineTo(8*40,7*40),a.lineTo(5*40,7*40),a.lineTo(5*40,5*40),a.lineTo(7*40,5*40),a.lineTo(7*40,2*40),a.lineTo(2*40,2*40),a.lineTo(2*40,5*40),a.lineTo(4*40,5*40),a.lineTo(4*40,7*40),a.lineTo(1*40,7*40),a.closePath(),a.stroke(),a.fill(),a.strokeStyle="#80808060",a.beginPath();for(let n=.5;n<9.5;n++)a.moveTo(n*40,0),a.lineTo(n*40,8*40);for(let n=.5;n<8.5;n++)a.moveTo(0,n*40),a.lineTo(9*40,n*40);a.stroke(),a.fillStyle="#CA7D3980",a.beginPath(),a.moveTo(.5*40,.5*40),a.lineTo(8.5*40,.5*40),a.lineTo(8.5*40,7.5*40),a.lineTo(5*40,7.5*40),a.lineTo(5*40,7*40),a.lineTo(8*40,7*40),a.lineTo(8*40,1*40),a.lineTo(1*40,1*40),a.lineTo(1*40,7*40),a.lineTo(4*40,7*40),a.lineTo(4*40,7.5*40),a.lineTo(.5*40,7.5*40),a.fill(),a.beginPath(),a.moveTo(2*40,2*40),a.lineTo(7*40,2*40),a.lineTo(7*40,5*40),a.lineTo(5*40,5*40),a.lineTo(5*40,4.5*40),a.lineTo(6.5*40,4.5*40),a.lineTo(6.5*40,2.5*40),a.lineTo(2.5*40,2.5*40),a.lineTo(2.5*40,4.5*40),a.lineTo(4*40,4.5*40),a.lineTo(4*40,5*40),a.lineTo(2*40,5*40),a.fill(),a.fillRect(4*40,4.5*40,40,120)},width:360,height:320}),`
...
`,s.jsx(o,{frontMatter:r})]})}function u(l={}){const{wrapper:e}={...c(),...l.components};return e?s.jsx(e,{...l,children:s.jsx(i,{...l})}):i(l)}export{u as default,r as frontMatter};
