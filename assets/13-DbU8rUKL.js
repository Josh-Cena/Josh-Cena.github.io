import{u as s,j as e}from"./index-DwRXtLVn.js";import{P as i,a as r}from"./_components-C1hTrXOn.js";import"./_commonjsHelpers-Cpj98o6Y.js";const d="/assets/13-breakout-CcUktQIU.gif",o={tags:["Intcode","Arcade game"],title:"Advent of Code 2019 - Day 13: Care Package",description:"Advent of Code 2019 - Day 13: Care Package, a problem that involves Intcode and Arcade game. Solution written in C++, with detailed walkthrough and proof.",year:2019,day:13};function a(n){const t={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",img:"img",p:"p",pre:"pre",span:"span",strong:"strong",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.h1,{children:["Advent of Code 2019 - Day 13",e.jsx(t.span,{className:"subtitle",children:"Care Package"})]}),e.jsx(i,{frontMatter:o}),`
...
`,e.jsxs(t.p,{children:["(One complaint: I didn't understand from the problem statement that each time only the ",e.jsx(t.strong,{children:"diff"})," is output, so at first I rendered the entire screen each time and wondered why the blocks disappeared!)"]}),e.jsx(r,{frontMatter:o})]})}function u(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}export{u as default,o as frontMatter};
