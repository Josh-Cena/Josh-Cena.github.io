...
`,e.jsxs(n.p,{children:["In part 1 some people may have hardcoded the 4 directions, which is what part 2 tries to prevent. Because the waypoint can be anywhere, we must implement proper rotation. Since we are already doing that, the only difference is the initial direction (",e.jsx(n.code,{children:"10 + 1j"})," instead of ",e.jsx(n.code,{children:"1"}),") and that ",e.jsx(n.code,{children:"N"}),"/",e.jsx(n.code,{children:"S"}),"/",e.jsx(n.code,{children:"E"}),"/",e.jsx(n.code,{children:"W"})," instructions affect the waypoint instead of the ship."]}),e.jsx(a,{frontMatter:i})]})}function l(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{l as default,i as frontMatter};
