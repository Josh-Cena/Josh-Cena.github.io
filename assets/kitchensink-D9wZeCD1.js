import{j as s,u as i,C as m}from"./index-DEJgW3cN.js";import{C as d}from"./index-BvT_Nn_v.js";const h="/assets/yale-logo-CzvkiTv6.png";function o({code:n}){return s.jsx("pre",{className:"mermaid",children:n})}const x=`---
...
\`\`\`
`;function p(n){return s.jsx(s.Fragment,{})}function j(n={}){return s.jsx(x,{...n,children:s.jsx(p,{...n})})}const y={description:"A collection of all Markdown syntaxes — for testing",title:"Kitchensink"};function a(n){const e={a:"a",annotation:"annotation",blockquote:"blockquote",code:"code",del:"del",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",hr:"hr",img:"img",input:"input",li:"li",math:"math",mi:"mi",mn:"mn",mo:"mo",mrow:"mrow",msqrt:"msqrt",mstyle:"mstyle",msup:"msup",mtable:"mtable",mtd:"mtd",mtr:"mtr",ol:"ol",p:"p",path:"path",pre:"pre",section:"section",semantics:"semantics",span:"span",strong:"strong",sup:"sup",svg:"svg",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...n.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h1,{children:"Kitchensink"}),`
`,`
`,s.jsxs("details",{children:[s.jsx("summary",{children:"Markdown source"}),s.jsx(m,{language:"md",children:j})]}),`
...
`]}),`
`]}),`
`,s.jsx(e.p,{children:s.jsx(e.img,{src:h,alt:"Local image"})}),`
...
`,s.jsx(e.h2,{children:"Mermaid diagram"}),`
`,s.jsx(o,{code:`graph TD;
    A-->B;
    A-->C;
    B-->D;
    C-->D;`}),`
`,s.jsx(e.h2,{children:"Canvas"}),`
`,s.jsx(d,{code:(l,t,r,c,g)=>{l.fillStyle="#39cac4",l.fillRect(10,10,t-20,r-20),l.fillStyle=c,l.font="20px sans-serif",l.fillText("Text works!",20,100)},width:200,height:200}),`
...
`]}),`
`]}),`
`]})]})}function f(n={}){const{wrapper:e}={...i(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(a,{...n})}):a(n)}export{f as default,y as frontMatter};
