import{t as e}from"./jsx-runtime-D57Vegw5.js";import{n as t}from"./lib-rxHYdfSX.js";import{n,t as r}from"./_components-BHKTFOi1.js";var i=e(),a={tags:[`BFS/DFS`],title:`Advent of Code 2022 - Day 24: Blizzard Basin`,description:`Advent of Code 2022 - Day 24: Blizzard Basin, a problem that involves BFS/DFS. Solution written in Haskell, with detailed walkthrough and proof.`,year:2022,day:24};function o(e){let o={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,span:`span`,...t(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(o.h1,{children:[`Advent of Code 2022 - Day 24`,(0,i.jsx)(o.span,{className:`subtitle`,children:`Blizzard Basin`})]}),(0,i.jsx)(n,{frontMatter:a}),`
`,(0,i.jsx)(o.h2,{children:`Part 1`}),`
`,(0,i.jsx)(o.p,{children:`All it takes is to do a BFS with the current time as part of the state. Also realize that you don't have to actually simulate the blizzards; given the time and a position, you can know if a blizzard is there by going backwards in the direction of the blizzard and checking if there was a blizzard there at time 0.`}),`
`,(0,i.jsxs)(o.p,{children:[`The `,(0,i.jsx)(o.code,{children:`canMoveTo`}),` function essentially determines the edges for a node `,(0,i.jsx)(o.code,{children:`(r, c, t)`}),` by checking if the position is out of bounds, is a wall, or has a blizzard at time `,(0,i.jsx)(o.code,{children:`t`}),`. If not, we can move there.`]}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-hs`,children:`canMoveTo :: Map (Int, Int) Char -> Int -> Int -> State -> Bool
...
`})}),`
`,(0,i.jsx)(o.p,{children:`Writing a BFS for the last time this year.`}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-hs`,children:`bfs ::
  Map (Int, Int) Char ->
  Int ->
  Int ->
  (Int, Int, Int) ->
    ...
    go (s@(r, c, t) Seq.:<| q) seen
      ...
      | otherwise =
          let next = [n | n <- neighbors s, canMoveTo board width height n, n \`Set.notMember\` seen]
           ...
           in go q' seen'
`})}),`
`,(0,i.jsxs)(o.p,{children:[`The answer is given by `,(0,i.jsx)(o.code,{children:`bfs board width height (0, 1, 0) (height + 1, width)`}),`.`]}),`
`,(0,i.jsx)(o.h2,{children:`Part 2`}),`
`,(0,i.jsx)(o.p,{children:`Just execute the BFS three times: from start to end, then from end to start, and finally from start to end again. Each time, pass the previous end time as the starting time for the next BFS.`}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-hs`,children:`let (_, _, t) =
      foldr
