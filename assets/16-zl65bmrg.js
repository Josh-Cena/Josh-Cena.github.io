...
`})}),`
`,(0,i.jsx)(a.p,{children:`Like in any constraint satisfaction problem, once we have the initial candidates, we can propagate constraints. We start with the narrowest constraints, satisfy them, and remove that possibility from all other sets. We repeat this until all sets are satisfied.`}),`
`,(0,i.jsxs)(a.p,{children:[`If we print `,(0,i.jsx)(a.code,{children:`candidate_fields`}),`, it looks like this:`]}),`
`,(0,i.jsx)(a.pre,{children:(0,i.jsx)(a.code,{className:`language-py`,children:`{
    14: {'type'},
    12: {'type', 'class'},
