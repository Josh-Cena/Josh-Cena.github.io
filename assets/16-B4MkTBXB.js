...
`})}),`
`,e.jsx(s.p,{children:"The performance is very satisfactory: a mere 270ms, which is merely 100ms more than part 1."}),e.jsx(o,{frontMatter:a})]})}function d(t={}){const{wrapper:s}={...i(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(n,{...t})}):n(t)}export{d as default,a as frontMatter};
