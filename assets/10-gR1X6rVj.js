...
`,(0,i.jsx)(a.p,{children:`Brackets are closed in reverse order, so we can iterate the remaining stack from the end (or top, since it's a stack) to get the sequence of required closing brackets.`}),`
`,(0,i.jsx)(a.pre,{children:(0,i.jsx)(a.code,{className:`language-ts`,children:`let lineScore = 0;
...
`})}),(0,i.jsx)(r,{frontMatter:e})]})}function o(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,i.jsx)(n,{...e,children:(0,i.jsx)(a,{...e})}):a(e)}o.meta={tags:[`Data structures`],title:`Advent of Code 2021 - Day 10: Syntax Scoring`,description:`Advent of Code 2021 - Day 10: Syntax Scoring, a problem that involves Data structures. Solution written in TypeScript, with detailed walkthrough and proof.`,year:2021,day:10};export{o as default};