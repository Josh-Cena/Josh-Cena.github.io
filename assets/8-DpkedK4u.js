...
`,e.jsxs(n.p,{children:["Once we have the mapping from scrambled letters to actual segments, we can decode the output values by looking up the output patterns using the ",e.jsx(n.code,{children:"digits"})," map above."]}),e.jsx(i,{frontMatter:s})]})}function o(t={}){const{wrapper:n}={...c(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(d,{...t})}):d(t)}export{o as default,s as frontMatter};
