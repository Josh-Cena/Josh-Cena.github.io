import{u as j,j as e}from"./index-DwRXtLVn.js";import{C as N}from"./index-DP-BdsL9.js";import{P as G,a as v}from"./_components-C8VjCMbT.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Ciqn2WuZ.js";const f={tags:["Computational"],title:"NACLO 2026 - Problem E: A Typical Problem",description:"NACLO 2026 - Problem E: A Typical Problem, a problem that involves Computational. Detailed solution and walkthrough.",year:2026,prob:"E"},i={};function w(Y){const t={code:"code",h1:"h1",li:"li",p:"p",span:"span",ul:"ul",...j(),...Y.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.h1,{children:["NACLO 2026 - Problem E",e.jsx(t.span,{className:"subtitle",children:"A Typical Problem"})]}),e.jsx(G,{frontMatter:f}),`
...
`,e.jsx(t.p,{children:'If one bites the bullet and at least calculate the feature responses for all 7 input grids given, then these 4 features all match both those of "G" and "Q" (their only differences are in the right and bottom right subgrids, but one always contains a straight edge and the other always contains a diagonal, so they have the same feature responses).'}),e.jsx(v,{frontMatter:f})]})}function x(Y={}){const{wrapper:t}={...j(),...Y.components};return t?e.jsx(t,{...Y,children:e.jsx(w,{...Y})}):w(Y)}export{i as canvasResources,x as default,f as frontMatter};
