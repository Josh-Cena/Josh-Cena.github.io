import{t as e}from"./jsx-runtime-DAs1UGHr.js";import{n as t}from"./lib-T-nEWGuF.js";import{n,t as r}from"./_components-DgNpooeQ.js";var i=e(),a={tags:[`Constraint satisfaction`],title:`Advent of Code 2020 - Day 16: Ticket Translation`,description:`Advent of Code 2020 - Day 16: Ticket Translation, a problem that involves Constraint satisfaction. Solution written in Python, with detailed walkthrough and proof.`,year:2020,day:16};function o(e){let o={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,span:`span`,...t(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(o.h1,{children:[`Advent of Code 2020 - Day 16`,(0,i.jsx)(o.span,{className:`subtitle`,children:`Ticket Translation`})]}),(0,i.jsx)(n,{frontMatter:a}),`
`,(0,i.jsx)(o.h2,{children:`Part 1`}),`
`,(0,i.jsx)(o.p,{children:`Part 1 is straightforward: collect a list of ranges, then for each number in each nearby ticket, check if it falls into any of the ranges.`}),`
...
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-python`,children:`candidate_fields = {i: set(rules.keys()) for i in range(len(valid_tickets[0]))}
...
`})}),`
`,(0,i.jsx)(o.p,{children:`Like in any constraint satisfaction problem, once we have the initial candidates, we can propagate constraints. We start with the narrowest constraints, satisfy them, and remove that possibility from all other sets. We repeat this until all sets are satisfied.`}),`
`,(0,i.jsxs)(o.p,{children:[`If we print `,(0,i.jsx)(o.code,{children:`candidate_fields`}),`, it looks like this:`]}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-py`,children:`{
    14: {'type'},
    12: {'type', 'class'},
