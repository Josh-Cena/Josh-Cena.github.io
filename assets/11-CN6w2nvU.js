    ...
    for dr in range(-1, 2):
        for dc in range(-1, 2):
            ...
            while 0 <= nr < len(grid) and 0 <= nc < len(grid[0]):
                ...
                nc = c + dc * d
    return res
`})}),(0,i.jsx)(r,{frontMatter:e})]})}function o(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,i.jsx)(n,{...e,children:(0,i.jsx)(a,{...e})}):a(e)}o.meta={tags:[`Cellular automata`],title:`Advent of Code 2020 - Day 11: Seating System`,description:`Advent of Code 2020 - Day 11: Seating System, a problem that involves Cellular automata. Solution written in Python, with detailed walkthrough and proof.`,year:2020,day:11};export{o as default};