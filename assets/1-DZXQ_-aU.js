...
cat(sum(as.numeric(nums)), "\\n")
`})}),`
`,e.jsx(i,{frontMatter:a})]})}function u(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{u as default,a as frontMatter};
