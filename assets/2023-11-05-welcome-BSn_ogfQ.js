import{j as e,u as i}from"./index-BGRydkNA.js";const r=new Intl.DateTimeFormat("en-US",{year:"numeric",month:"long",day:"numeric"});function l({frontMatter:n}){const t=new Date(n.date),a=t.valueOf()+t.getTimezoneOffset()*60*1e3;return e.jsx("div",{children:e.jsx("time",{dateTime:n.date,children:r.format(new Date(a))})})}const o={description:"An overview of what comes, what stays, and what goes.",date:"2023-11-05",title:"Welcome to my new website!"};function s(n){const t={a:"a",em:"em",h1:"h1",h2:"h2",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{children:"Welcome to my new website!"}),`
`,`
`,e.jsx(l,{frontMatter:o}),`
...
`]}),`
`,e.jsx(t.hr,{}),`
`,e.jsx(t.p,{children:`I hesitated about creating a "blog" because I know very well that I won't write more than three posts here, but I have to write this particular one anyway, so, here we are. I hope you enjoy the new website!`})]})}function h(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}const d=Object.freeze(Object.defineProperty({__proto__:null,default:h,frontMatter:o},Symbol.toStringTag,{value:"Module"}));export{l as P,d as _,o as f};
