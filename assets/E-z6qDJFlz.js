import{u as t,j as n}from"./index-DyI1T4xN.js";import{P as a,a as l}from"./_components-YM4q2yub.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Ciqn2WuZ.js";const r={tags:["Writing system"],title:"NACLO 2025 - Problem E: Around the World in Armenian",description:"NACLO 2025 - Problem E: Around the World in Armenian, a problem that involves Writing system. Detailed solution and walkthrough.",year:2025,prob:"E"};function s(i){const e={h1:"h1",li:"li",ol:"ol",p:"p",span:"span",strong:"strong",ul:"ul",...t(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsxs(e.h1,{children:["NACLO 2025 - Problem E",n.jsx(e.span,{className:"subtitle",children:"Around the World in Armenian"})]}),n.jsx(a,{frontMatter:r}),`
`,`
...
`]}),`
`,n.jsx(e.p,{children:'For E3, just replace the letters one-by-one. "Cameroon" should be transcribed as "Kamerun".'}),n.jsx(l,{frontMatter:r})]})}function g(i={}){const{wrapper:e}={...t(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(s,{...i})}):s(i)}export{g as default,r as frontMatter};
