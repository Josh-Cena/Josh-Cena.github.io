import{u as c,j as s}from"./index-viUjO3pU.js";import{P as t,a as m}from"./_components-CnEwx4LA.js";import{C as o}from"./index-Dhm_Fq2Y.js";import"./_commonjsHelpers-Cpj98o6Y.js";const r={tags:["Coordinate compression","Geometry"],description:"Advent of Code 2023 - Day 18: Lavaduct Lagoon, a problem that involves Coordinate compression and Geometry. Solution written in R, with detailed walkthrough and proof.",year:2023,day:18,title:"Advent of Code 2023 - Day 18: Lavaduct Lagoon"};function i(l){const e={a:"a",annotation:"annotation",code:"code",em:"em",h1:"h1",math:"math",mfrac:"mfrac",mi:"mi",mn:"mn",mo:"mo",mrow:"mrow",p:"p",pre:"pre",semantics:"semantics",span:"span",...c(),...l.components};return s.jsxs(s.Fragment,{children:[s.jsxs(e.h1,{children:["Advent of Code 2023 - Day 18",s.jsx(e.span,{className:"subtitle",children:"Lavaduct Lagoon"})]}),`
`,`
...
`,s.jsx(o,{code:(a,d,h,p,j)=>{a.fillStyle="#39CAC480",a.beginPath(),a.moveTo(40,40),a.lineTo(320,40),a.lineTo(320,280),a.lineTo(200,280),a.lineTo(200,200),a.lineTo(280,200),a.lineTo(280,80),a.lineTo(80,80),a.lineTo(80,200),a.lineTo(160,200),a.lineTo(160,280),a.lineTo(40,280),a.closePath(),a.stroke(),a.fill(),a.strokeStyle="#80808060",a.beginPath();for(let n=.5;n<9.5;n++)a.moveTo(n*40,0),a.lineTo(n*40,320);for(let n=.5;n<8.5;n++)a.moveTo(0,n*40),a.lineTo(360,n*40);a.stroke(),a.fillStyle="#CA7D3980",a.beginPath(),a.moveTo(.5*40,.5*40),a.lineTo(8.5*40,.5*40),a.lineTo(8.5*40,7.5*40),a.lineTo(200,7.5*40),a.lineTo(200,280),a.lineTo(320,280),a.lineTo(320,40),a.lineTo(40,40),a.lineTo(40,280),a.lineTo(160,280),a.lineTo(160,7.5*40),a.lineTo(.5*40,7.5*40),a.fill(),a.beginPath(),a.moveTo(80,80),a.lineTo(280,80),a.lineTo(280,200),a.lineTo(200,200),a.lineTo(200,4.5*40),a.lineTo(6.5*40,4.5*40),a.lineTo(6.5*40,2.5*40),a.lineTo(2.5*40,2.5*40),a.lineTo(2.5*40,4.5*40),a.lineTo(160,4.5*40),a.lineTo(160,200),a.lineTo(80,200),a.fill(),a.fillRect(160,4.5*40,40,120)},width:360,height:320}),`
...
`,s.jsx(m,{frontMatter:r})]})}function _(l={}){const{wrapper:e}={...c(),...l.components};return e?s.jsx(e,{...l,children:s.jsx(i,{...l})}):i(l)}export{_ as default,r as frontMatter};
