...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-python",children:`def evolve(active: set[Point], get_neighbors: Callable[[Point], list[Point]]) -> set[Point]:
    ...
    return new_active
`})}),`
`,e.jsx(n.p,{children:"The neighbors are just the six directions defined above."}),e.jsx(s,{frontMatter:t})]})}function h(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{h as default,t as frontMatter};
