import{t as e}from"./jsx-runtime-BnxRlLMJ.js";import{n as t}from"./lib-8Y9jQ4sF.js";import"./Link-p8Ht0V-s.js";import"./chroma-js-C4qMxh81.js";import{i as n,r}from"./_components-BMUVh2lY.js";var i=e(),a={tags:[`Computational`,`Puzzle`],title:`NACLO 2022 - Problem G: Out of Order`,description:`NACLO 2022 - Problem G: Out of Order, a problem that involves Computational and Puzzle. Detailed solution and walkthrough.`,year:2022,prob:`G`};function o(e){let o={code:`code`,em:`em`,h1:`h1`,p:`p`,pre:`pre`,span:`span`,...t(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(o.h1,{children:[`NACLO 2022 - Problem G`,(0,i.jsx)(o.span,{className:`subtitle`,children:`Out of Order`})]}),(0,i.jsx)(n,{frontMatter:a}),`
`,`
`,(0,i.jsx)(o.p,{children:`G1: it's like playing scrabble :) The answer is "FORTY FIVE".`}),`
`,(0,i.jsx)(o.p,{children:`In G2, take the letters and sort them by the index. Since we are doing it post hoc, I have this little script.`}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-js`,children:`function getResult(input) {
  return input
    .split(", ")
    .map((x) => {
      const parts = x.split(":");
...
`})}),`
`,(0,i.jsx)(o.p,{children:`And the result is: "IVE MADE MY POSITION CLEAR".`}),`
`,(0,i.jsx)(o.p,{children:`In G3, looks like it just has the index and the letter swapped.`}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-js`,children:`function getResult(input) {
  return input
    .split(", ")
    .map((x) => {
...
`})}),`
`,(0,i.jsx)(o.p,{children:`The result is "NALPPUKCAB", which doesn't make sense. But if we reverse it, we get "BACKUP PLAN", which is the answer.`}),`
`,(0,i.jsx)(o.p,{children:`In G4, the idea is that "E:RRRL" means you start from the right, go right, right, right, left, and end up at the letter "E". Again this is okay to do manually, but I wrote a script for convenience.`}),`
`,(0,i.jsx)(o.pre,{children:(0,i.jsx)(o.code,{className:`language-js`,children:`function getResult(input) {
...
`})}),`
`,(0,i.jsx)(o.p,{children:`The only valid answer is "PAY ATTENTION TO YOUR SURROUNDINGS".`}),(0,i.jsx)(r,{frontMatter:a})]})}function s(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,i.jsx)(n,{...e,children:(0,i.jsx)(o,{...e})}):o(e)}export{s as default,a as frontMatter};