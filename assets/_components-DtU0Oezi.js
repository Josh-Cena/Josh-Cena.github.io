import{t as e}from"./jsx-runtime-BnxRlLMJ.js";import{t}from"./Link-CEJsqf-b.js";import{t as n}from"./chroma-js-DuFX2F1K.js";var r=`Year,Index,Mean ± Stdev,Median,Max,Median Solve %,Round
...
2007,H,N/A,N/A,N/A,N/A,Open`.split(`
`).slice(1).map(e=>{let[t,n,r,i,a,o,s]=e.split(`,`),[c,l]=r.split(` ± `).map(e=>parseFloat(e));return{year:parseInt(t,10),index:n,mean:c,std:l,median:parseFloat(i),max:parseFloat(a),medianSolvePct:parseFloat(o.replace(`%`,``))/100,isOpen:s===`Open`}}),i=new Map;for(let e of r)i.set(`${e.year}${e.index}`,e);var a={tag:`_tag_1erk9_1`,paginator:`_paginator_1erk9_11`,yearIndex:`_yearIndex_1erk9_17`},o=e(),s=n.scale([`#ca393e`,`#3eca39`]).domain([0,1]);function c({prob:e,alwaysSolid:t}){let r=i.get(e);if(!r||Number.isNaN(r.medianSolvePct))return`N/A`;let a=s(r.medianSolvePct).hex();return(0,o.jsxs)(`span`,{style:{...r.isOpen||t?{backgroundColor:a,color:n(a).luminance()<.5?`white`:`black`}:{border:`2px solid ${a}`,color:a},padding:`0.1em 0.4em`,borderRadius:`var(--border-radius-small)`,fontWeight:`bold`,fontVariantNumeric:`tabular-nums`},title:`Median Solve Percentage: ${(r.medianSolvePct*100).toFixed(2)}%`,children:[(r.medianSolvePct*100).toFixed(2),`%`]})}function l(e){let t=`A`;for(let n of i.keys()){let r=/^(?<year>\d{4})(?<prob>[A-Z])$/u.exec(n);r?.groups?.year===e.toString()&&r.groups.prob>t&&(t=r.groups.prob)}return t}function u({frontMatter:e}){let n=e.prob.charCodeAt(0);return(0,o.jsxs)(`nav`,{className:a.paginator,children:[e.prob===`A`?(0,o.jsx)(`span`,{className:`phantom`,children:`← Previous`}):(0,o.jsx)(t,{href:`/notes/naclo/${e.year}/${String.fromCharCode(n-1)}/`.toLowerCase(),children:`← Previous`}),` `,(0,o.jsx)(t,{href:`/notes/naclo/${e.year}/`,children:`Back to year index`}),` `,e.prob===l(e.year)?(0,o.jsx)(`span`,{className:`phantom`,children:`→ Next`}):(0,o.jsx)(t,{href:`/notes/naclo/${e.year}/${String.fromCharCode(n+1)}/`.toLowerCase(),children:`Next →`})]})}function d({frontMatter:e}){let n=e.year===2024?`https://naclo.org/resources/problems/2024/NACLO2024ROUND${e.prob<=`H`?`1`:`2`}_booklet.pdf`:`https://naclo.org/resources/problems/${e.year}/N${e.year}-${e.prob}.pdf`,r=e.year===2024?`https://naclo.org/resources/problems/2024/NACLO2024ROUND${e.prob<=`H`?`1`:`2`}SOL.pdf`:`https://naclo.org/resources/problems/${e.year}/N${e.year}-${e.prob}S.pdf`,s=i.get(`${e.year}${e.prob}`);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(`p`,{children:[s?.isOpen?`Open round`:`Invitational round`,` | `,s?.max,` points |`,` `,(0,o.jsx)(c,{prob:`${e.year}${e.prob}`,alwaysSolid:!0}),` `,`| `,(0,o.jsx)(t,{href:n,children:`Problem statement`}),` |`,` `,(0,o.jsx)(t,{href:r,children:`Official solution`}),` | Tags:`,` `,e.tags.map(e=>(0,o.jsx)(`span`,{className:a.tag,children:e},e))]}),(0,o.jsx)(u,{frontMatter:e})]})}function f({frontMatter:e}){return(0,o.jsx)(u,{frontMatter:e})}function p({year:e}){return(0,o.jsxs)(`nav`,{className:a.paginator,children:[e===2022?(0,o.jsx)(`span`,{className:`phantom`,children:`← Previous year`}):(0,o.jsx)(t,{href:`/notes/naclo/${e-1}/`,children:`← Previous year`}),` `,(0,o.jsx)(t,{href:`/notes/naclo/`,children:`Back to NACLO index`}),` `,e===2026?(0,o.jsx)(`span`,{className:`phantom`,children:`→ Next year`}):(0,o.jsx)(t,{href:`/notes/naclo/${e+1}/`,children:`→ Next year`})]})}function m({year:e}){return(0,o.jsx)(`nav`,{children:(0,o.jsx)(`ul`,{className:a.yearIndex,children:Array.from({length:l(e).charCodeAt(0)-65+1},(e,t)=>t).map(n=>(0,o.jsx)(`li`,{children:(0,o.jsx)(t,{href:`/notes/naclo/${e}/${String.fromCharCode(65+n)}/`.toLowerCase(),children:String.fromCharCode(65+n)})},n))})})}function h({year:e}){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(`p`,{children:[`Problem statements:`,` `,(0,o.jsx)(t,{href:`https://naclo.org/resources/problems/${e}/NACLO${e}ROUND1.pdf`,children:`Round 1`}),`,`,` `,(0,o.jsx)(t,{href:`https://naclo.org/resources/problems/${e}/NACLO${e}ROUND2.pdf`,children:`Round 2`}),` `,`| Official solutions:`,` `,(0,o.jsx)(t,{href:`https://naclo.org/resources/problems/${e}/NACLO${e}ROUND1SOL.pdf`,children:`Round 1`}),`,`,` `,(0,o.jsx)(t,{href:`https://naclo.org/resources/problems/${e}/NACLO${e}ROUND2SOL.pdf`,children:`Round 2`})]}),(0,o.jsx)(p,{year:e}),(0,o.jsx)(m,{year:e})]})}function g({year:e}){return(0,o.jsxs)(`nav`,{className:a.paginator,children:[e===2022?(0,o.jsx)(`span`,{className:`phantom`,children:`← Previous year`}):(0,o.jsx)(t,{href:`/notes/yale/naclo/${e-1}/`,children:`← Previous year`}),` `,(0,o.jsx)(t,{href:`/notes/yale/naclo/`,children:`Back to NACLO index`}),` `,e===2025?(0,o.jsx)(`span`,{className:`phantom`,children:`→ Next year`}):(0,o.jsx)(t,{href:`/notes/yale/naclo/${e+1}/`,children:`→ Next year`})]})}export{h as a,d as i,c as n,f as r,g as t};