...
`]}),`
`]}),`
`,s.jsx(e.p,{children:s.jsx(e.img,{src:d,alt:"Local image"})}),`
...
`,s.jsx(h,{code:`graph TD;
    A-->B;
    A-->C;
    B-->D;
    C-->D;`}),`
`,s.jsx(e.h2,{children:"Canvas"}),`
`,s.jsx(m,{code:(l,t,r,c,x)=>{l.fillStyle="#39cac4",l.fillRect(10,10,t-20,r-20),l.fillStyle=c,l.font="20px sans-serif",l.fillText("Text works!",20,100)},width:200,height:200}),`
...
`]}),`
`]}),`
`]})]})}function y(n={}){const{wrapper:e}={...i(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(a,{...n})}):a(n)}export{y as default,N as frontMatter};
