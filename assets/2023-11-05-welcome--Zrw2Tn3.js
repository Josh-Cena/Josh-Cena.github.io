import{u as i,j as e}from"./index-DwRXtLVn.js";import{P as o}from"./index-DI15K2Bh.js";import"./_commonjsHelpers-Cpj98o6Y.js";const a={description:"An overview of what comes, what stays, and what goes.",date:"2023-11-05",title:"Welcome to my new website!"};function n(s){const t={a:"a",em:"em",h1:"h1",h2:"h2",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{children:"Welcome to my new website!"}),e.jsx(o,{frontMatter:a}),`
...
`]}),`
`,e.jsx(t.hr,{}),`
`,e.jsx(t.p,{children:`I hesitated about creating a "blog" because I know very well that I won't write more than three posts here, but I have to write this particular one anyway, so, here we are. I hope you enjoy the new website!`})]})}function c(s={}){const{wrapper:t}={...i(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(n,{...s})}):n(s)}export{c as default,a as frontMatter};
