import{u as o,j as e}from"./index-DyI1T4xN.js";import{P as i,a}from"./_components-P82CQNCv.js";import"./_commonjsHelpers-Cpj98o6Y.js";const r={tags:["Parsing"],title:"Advent of Code 2020 - Day 18: Operation Order",description:"Advent of Code 2020 - Day 18: Operation Order, a problem that involves Parsing. Solution written in Python, with detailed walkthrough and proof.",year:2020,day:18};function s(n){const t={code:"code",h1:"h1",p:"p",pre:"pre",span:"span",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.h1,{children:["Advent of Code 2020 - Day 18",e.jsx(t.span,{className:"subtitle",children:"Operation Order"})]}),e.jsx(i,{frontMatter:r}),`
...
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-python",children:`class ExprEvaluator(ast.NodeVisitor):
    ...
    def visit_Constant(self, node):
        return node.value
`})}),`
`,e.jsx(t.p,{children:"Of course I could have built an actual recursive descent parser, but this was way easier and is what nature intended for AoC purposes—language choices reward simple solutions."}),e.jsx(a,{frontMatter:r})]})}function h(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{h as default,r as frontMatter};
