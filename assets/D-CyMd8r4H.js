...
`,(0,i.jsx)(a.li,{children:`M = { plum, strawberry }, M' = { crow }. Need a language where "crow" shares a word with "plum" and/or "strawberry": Bassa, Bété.`}),`
`,(0,i.jsx)(a.li,{children:`M = { plum, ocean }, M' = { sky }. Need a language where "sky" shares a word with "plum" and/or "ocean": Apinaye, Bassa, Bété, English, Teribe (only Tsafiki doesn't work).`}),`
`,(0,i.jsx)(a.li,{children:`M = { plum, strawberry }, M' = { plum }. This is a direct translation, so any pivot will do.`}),`
`,(0,i.jsx)(a.li,{children:`M = { plum, strawberry, banana }, M' = { grass, sky, ocean }. Need any language that doesn't distinguish one of "grass", "sky", or "ocean" from one of "plum", "strawberry", or "banana": Apinaye, Bassa, Bété, Teribe.`}),`
`,(0,i.jsx)(a.li,{children:`M = { banana }, M' = { snow }. Need a language where "snow" shares a word with "banana": only Bassa.`}),`
`,(0,i.jsx)(a.li,{children:`M = { grass }, M' = { plum, strawberry }. Need a language where "plum" and/or "strawberry" share a word with "grass": Apinaye, Bassa, Bété.`}),`
`]}),`
