...
and optimal_total_path_cost poses depth memo =
  ...
  aux 0 poses
`})}),`
`,e.jsxs(s.p,{children:["Now implementing a sequence of presses on the numpad just requires calling ",e.jsx(s.code,{children:"optimal_total_path_cost"})," with the sequence of coordinates."]}),e.jsx(c,{frontMatter:a})]})}function d(n={}){const{wrapper:s}={...l(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{d as default,a as frontMatter};
