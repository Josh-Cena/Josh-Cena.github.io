...
for s in candidate_fields.values():
    fields.append(s.pop())
`})}),`
`,e.jsx(r,{frontMatter:s})]})}function c(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{c as default,s as frontMatter};
