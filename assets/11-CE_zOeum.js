...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-ocaml",children:`let evolve nums =
  IntMap.fold
    ...
    nums IntMap.empty
`})}),`
`,n.jsxs(e.p,{children:["Parts 1 and 2 just apply ",n.jsx(e.code,{children:"evolve"})," 25 and 75 times, respectively."]}),n.jsx(r,{frontMatter:s})]})}function h(t={}){const{wrapper:e}={...a(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(o,{...t})}):o(t)}export{h as default,s as frontMatter};
