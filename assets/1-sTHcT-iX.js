import{u as r,j as e}from"./index-DEJgW3cN.js";import{F as o,a as i}from"./_components-C_Mh6GSJ.js";const a={description:"Advent of Code 2023 - Day 1: Trebuchet?!. Written in R.",tags:["String manipulation"],year:2023,day:1,title:"AoC 2023 D1: Trebuchet?!"};function s(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{children:"AoC 2023 D1: Trebuchet?!"}),`
`,`
...
cat(sum(as.numeric(nums)), "\\n")
`})}),`
`,e.jsx(i,{frontMatter:a})]})}function d(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{d as default,a as frontMatter};
