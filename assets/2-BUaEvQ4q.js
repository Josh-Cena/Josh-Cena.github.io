...
shape game = case find (\\(opp, _, score) -> (opp, scoreToOutcome score) == game) outcomes of
  ...
  Nothing -> 'X'
`})}),`
`,e.jsx(c,{frontMatter:o})]})}function p(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{p as default,o as frontMatter};
