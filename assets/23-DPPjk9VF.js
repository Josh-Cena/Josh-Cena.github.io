import{u as s,j as e}from"./index-DwRXtLVn.js";import{P as i,a}from"./_components-C1hTrXOn.js";import"./_commonjsHelpers-Cpj98o6Y.js";const o={tags:["Intcode"],title:"Advent of Code 2019 - Day 23: Category Six",description:"Advent of Code 2019 - Day 23: Category Six, a problem that involves Intcode. Solution written in C++, with detailed walkthrough and proof.",year:2019,day:23};function r(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",span:"span",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.h1,{children:["Advent of Code 2019 - Day 23",e.jsx(t.span,{className:"subtitle",children:"Category Six"})]}),e.jsx(i,{frontMatter:o}),`
...
`,e.jsxs(t.p,{children:["When the network is idle, and the NAT has a packet stored, I send the stored packet to program 0 (which resets its ",e.jsx(t.code,{children:"starved_cycles"}),"). I also keep track of the last Y value sent by the NAT, and print it and exit if the same Y value is sent twice in a row."]}),e.jsx(a,{frontMatter:o})]})}function l(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{l as default,o as frontMatter};
