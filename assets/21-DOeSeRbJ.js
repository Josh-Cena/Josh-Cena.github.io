import{u as o,j as e}from"./index-DyI1T4xN.js";import{P as a,a as l}from"./_components-P82CQNCv.js";import"./_commonjsHelpers-Cpj98o6Y.js";const r={tags:["Dynamic programming"],title:"Advent of Code 2021 - Day 21: Dirac Dice",description:"Advent of Code 2021 - Day 21: Dirac Dice, a problem that involves Dynamic programming. Solution written in TypeScript, with detailed walkthrough and proof.",year:2021,day:21};function s(t){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",p:"p",pre:"pre",span:"span",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h1,{children:["Advent of Code 2021 - Day 21",e.jsx(n.span,{className:"subtitle",children:"Dirac Dice"})]}),e.jsx(a,{frontMatter:r}),`
...
`})}),`
`,e.jsxs(n.p,{children:["Note that we have to encode the state as a ",e.jsx(n.em,{children:"joint"})," state of both players. If we track states for each player separately, then a dice roll of player 1 would not multiply the number of universes for each state of player 2, leading to a lower count."]}),e.jsx(l,{frontMatter:r})]})}function p(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{p as default,r as frontMatter};
