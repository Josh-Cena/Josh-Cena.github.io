...
Printf.printf "%d\\n" (List.length st_uniq)
`})}),`
`,t.jsxs(e.p,{children:["Again, because in reality there's a single optimal target state, we could have picked that single ",t.jsx(e.code,{children:"e"})," state, instead of using loops, but this is more robust."]}),t.jsx(r,{frontMatter:s})]})}function c(n={}){const{wrapper:e}={...a(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(i,{...n})}):i(n)}export{c as default,s as frontMatter};
