import{u as a,j as e}from"./index-CKqa2xZ3.js";import{P as i,a as o}from"./_components-Ci0FrSUn.js";import"./_commonjsHelpers-CqkleIqs.js";const t={tags:["BFS/DFS"],title:"Advent of Code 2024 - Day 7: Bridge Repair",description:"Advent of Code 2024 - Day 7: Bridge Repair, a problem that involves BFS/DFS. Solution written in OCaml, with detailed walkthrough and proof.",year:2024,day:7};function r(n){const s={a:"a",annotation:"annotation",code:"code",em:"em",h1:"h1",h2:"h2",math:"math",mn:"mn",mo:"mo",mrow:"mrow",msup:"msup",p:"p",pre:"pre",semantics:"semantics",span:"span",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.h1,{children:["Advent of Code 2024 - Day 7",e.jsx(s.span,{className:"subtitle",children:"Bridge Repair"})]}),e.jsx(i,{frontMatter:t}),`
...
`})}),e.jsx(o,{frontMatter:t})]})}function d(n={}){const{wrapper:s}={...a(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(r,{...n})}):r(n)}export{d as default,t as frontMatter};
