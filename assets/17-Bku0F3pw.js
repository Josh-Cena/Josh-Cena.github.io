import{u as r,j as e}from"./index-DEJgW3cN.js";import{F as o,a}from"./_components-C_Mh6GSJ.js";const c="/assets/17-vscode-BwLr3OPS.png",s={description:"Advent of Code 2019 - Day 17: Set and Forget. Written in C++.",tags:["Intcode","Grid walking","String manipulation","Manual inspection"],year:2019,day:17,title:"AoC 2019 D17: Set and Forget"};function i(t){const n={code:"code",h1:"h1",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{frontMatter:s}),`
`,e.jsx(n.h1,{children:"AoC 2019 D17: Set and Forget"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{src:c,alt:"Finding repeated substrings in VS Code"})}),`
`,e.jsx(n.p,{children:"Of course, this isn't a general solution. To implement this logic in code, the idea is this:"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["We enumerate all prefixes of length up to 21 characters as function A. The prefix must end at a comma. (e.g., ",e.jsx(n.code,{children:"R,8,L,12,R,8"}),")"]}),`
`,e.jsxs(n.li,{children:["We split the sequence by A into non-empty segments. (e.g., ",e.jsx(n.code,{children:'["R,12,L,8,R,10,R,12,L,8,R,10,", "R,8,L,8,L,8,R,8,R,10,", "R,8,L,8,L,8,R,8,R,10,R,12,L,8,R,10,R,8,L,8,L,8,R,8,R,10,"]'}),")"]}),`
`,e.jsxs(n.li,{children:["For the first segment, we enumerate all prefixes of length up to 21 characters as function B. Again, the prefix must end at a comma. (e.g., ",e.jsx(n.code,{children:"R,12,L,8,"}),")"]}),`
`,e.jsxs(n.li,{children:["We split all segments by B into non-empty segments. (e.g., ",e.jsx(n.code,{children:'["R,10,", "R,10,", "R,8,L,8,L,8,R,8,R,10,", "R,8,L,8,L,8,R,8,R,10,", "R,10,R,8,L,8,L,8,R,8,R,10,"]'}),")"]}),`
