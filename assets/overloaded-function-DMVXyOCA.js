import{t as e}from"./jsx-runtime-BnxRlLMJ.js";import{n as t}from"./lib-8Y9jQ4sF.js";var n=e();function r(e){let r={code:`code`,h1:`h1`,p:`p`,pre:`pre`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{children:`Overloaded functions`}),`
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:`language-ts`,children:`declare class OverloadedFunction extends Function {
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:`language-js`,children:`const f = new OverloadedFunction([
  (a) => a + 100,
  (a, b) => a * b,
  (a, b, c) => a + b + c,
]);
...
console.log(h(1));
console.log(h(1n));
`})})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}i.meta={description:`A JavaScript snippet to implement overloaded functions using type predicates.`,title:`Overloaded functions`};export{i as default};