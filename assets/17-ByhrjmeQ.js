...
`})}),`
`,e.jsxs(n.p,{children:["After acquiring the functions A, B, and C, I can replace their occurrences in the movement sequence with ",e.jsx(n.code,{children:"A,"}),", ",e.jsx(n.code,{children:"B,"}),", and ",e.jsx(n.code,{children:"C,"})," respectively, and finally send the main routine and functions to the program."]}),e.jsx(a,{frontMatter:s})]})}function p(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{p as default,s as frontMatter};
