import{u as s,j as e}from"./index-DwRXtLVn.js";import{P as a,a as o}from"./_components-C1hTrXOn.js";import"./_commonjsHelpers-Cpj98o6Y.js";const i={tags:["Image processing","Geometry"],title:"Advent of Code 2020 - Day 20: Jurassic Jigsaw",description:"Advent of Code 2020 - Day 20: Jurassic Jigsaw, a problem that involves Image processing and Geometry. Solution written in Python, with detailed walkthrough and proof.",year:2020,day:20};function r(t){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",span:"span",strong:"strong",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h1,{children:["Advent of Code 2020 - Day 20",e.jsx(n.span,{className:"subtitle",children:"Jurassic Jigsaw"})]}),e.jsx(a,{frontMatter:i}),`
...
`})}),`
`,e.jsxs(n.p,{children:["We just rotate and flip this array in all 8 orientations, and for each orientation, we slide it over the entire image and check for matches. If we find a match, we mark those positions as ",e.jsx(n.code,{children:"O"})," in the image. At the end, we count the number of ",e.jsx(n.code,{children:"#"})," remaining in the image."]}),e.jsx(o,{frontMatter:i})]})}function c(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{c as default,i as frontMatter};
