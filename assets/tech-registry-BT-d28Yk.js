import{u as i,j as e}from"./index-CYq-bCfF.js";import"./_commonjsHelpers-Cpj98o6Y.js";const o={description:"A registry of the technologies I use and how to update each one.",title:"My tech registry"};function n(l){const s={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{children:"My tech registry"}),`
...
`]})]})}function t(l={}){const{wrapper:s}={...i(),...l.components};return s?e.jsx(s,{...l,children:e.jsx(n,{...l})}):n(l)}export{t as default,o as frontMatter};
