import{u as t,j as n}from"./index-TXYOrs-s.js";import"./_commonjsHelpers-Cpj98o6Y.js";const s={description:"A JavaScript snippet to implement overloaded functions using type predicates.",title:"Overloaded functions"};function r(o){const e={code:"code",h1:"h1",p:"p",pre:"pre",...t(),...o.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{children:"Overloaded functions"}),`
...
console.log(h(1));
console.log(h(1n));
`})})]})}function c(o={}){const{wrapper:e}={...t(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(r,{...o})}):r(o)}export{c as default,s as frontMatter};
