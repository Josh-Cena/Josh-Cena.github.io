import{u as i,j as s}from"./index-DwRXtLVn.js";import{P as l,a as r}from"./_components-C1hTrXOn.js";import"./_commonjsHelpers-Cpj98o6Y.js";const a={tags:["Image processing","Geometry"],title:"Advent of Code 2021 - Day 19: Beacon Scanner",description:"Advent of Code 2021 - Day 19: Beacon Scanner, a problem that involves Image processing and Geometry. Solution written in TypeScript, with detailed walkthrough and proof.",year:2021,day:19};function t(n){const e={a:"a",annotation:"annotation",code:"code",em:"em",h1:"h1",math:"math",mi:"mi",mn:"mn",mo:"mo",mrow:"mrow",msub:"msub",p:"p",pre:"pre",semantics:"semantics",span:"span",...i(),...n.components};return s.jsxs(s.Fragment,{children:[s.jsxs(e.h1,{children:["Advent of Code 2021 - Day 19",s.jsx(e.span,{className:"subtitle",children:"Beacon Scanner"})]}),s.jsx(l,{frontMatter:a}),`
...
`})}),`
`,s.jsxs(e.p,{children:["Part 1 asks for ",s.jsx(e.code,{children:"beaconPositions.length"}),", and part 2 is trivial given ",s.jsx(e.code,{children:"scannerPositions"}),"."]}),s.jsx(r,{frontMatter:a})]})}function o(n={}){const{wrapper:e}={...i(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(t,{...n})}):t(n)}export{o as default,a as frontMatter};
