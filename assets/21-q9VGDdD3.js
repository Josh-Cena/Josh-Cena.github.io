import{u as s,j as n}from"./index-DyI1T4xN.js";import{P as i,a as r}from"./_components-P82CQNCv.js";import"./_commonjsHelpers-Cpj98o6Y.js";const o={tags:["Intcode","Puzzle"],title:"Advent of Code 2019 - Day 21: Springdroid Adventure",description:"Advent of Code 2019 - Day 21: Springdroid Adventure, a problem that involves Intcode and Puzzle. Solution written in C++, with detailed walkthrough and proof.",year:2019,day:21};function a(t){const e={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",span:"span",...s(),...t.components};return n.jsxs(n.Fragment,{children:[`
`,n.jsxs(e.h1,{children:["Advent of Code 2019 - Day 21",n.jsx(e.span,{className:"subtitle",children:"Springdroid Adventure"})]}),n.jsx(i,{frontMatter:o}),`
...
RUN
`})}),`
`,n.jsxs(e.p,{children:["Note that to calculate ",n.jsx(e.code,{children:"(E or H)"}),", we assume that ",n.jsx(e.code,{children:"T"})," starts to be false. ",n.jsx(e.code,{children:"T"})," was previously ",n.jsx(e.code,{children:"A and B and C"}),"; if that is true, then ",n.jsx(e.code,{children:"J"})," is definitely false, so it's not a problem."]}),n.jsx(r,{frontMatter:o})]})}function c(t={}){const{wrapper:e}={...s(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(a,{...t})}):a(t)}export{c as default,o as frontMatter};
