import{u as r,j as e}from"./index-CuM7bDfp.js";import{F as a,a as i}from"./_components-1-OWSA-J.js";const n={tags:["Intcode"],description:"Advent of Code 2019 - Day 9: Sensor Boost, a problem that involves Intcode. Solution written in C++, with detailed walkthrough and proof.",year:2019,day:9,title:"Advent of Code 2019 - Day 9: Sensor Boost"};function s(t){const o={code:"code",h1:"h1",li:"li",span:"span",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(o.h1,{children:["Advent of Code 2019 - Day 9",e.jsx(o.span,{className:"subtitle",children:"Sensor Boost"})]}),`
`,`
...
`]}),`
`,e.jsx(i,{frontMatter:n})]})}function c(t={}){const{wrapper:o}={...r(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(s,{...t})}):s(t)}export{c as default,n as frontMatter};
