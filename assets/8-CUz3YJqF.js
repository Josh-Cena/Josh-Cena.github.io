import{u as r,j as e}from"./index-DwRXtLVn.js";import{P as s,a as o}from"./_components-C1hTrXOn.js";import"./_commonjsHelpers-Cpj98o6Y.js";const a={tags:["Image processing","Manual inspection"],title:"Advent of Code 2019 - Day 8: Space Image Format",description:"Advent of Code 2019 - Day 8: Space Image Format, a problem that involves Image processing and Manual inspection. Solution written in C++, with detailed walkthrough and proof.",year:2019,day:8};function i(t){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",span:"span",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h1,{children:["Advent of Code 2019 - Day 8",e.jsx(n.span,{className:"subtitle",children:"Space Image Format"})]}),e.jsx(s,{frontMatter:a}),`
...
#    #  #   #  #  # #  #
####  ###   #  #  # ###
`})}),e.jsx(o,{frontMatter:a})]})}function h(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{h as default,a as frontMatter};
