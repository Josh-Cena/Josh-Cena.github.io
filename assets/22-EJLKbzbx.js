import{u as m,j as e}from"./index-Cpgx5Zsn.js";import{C as b}from"./index-C4h-hl8M.js";import{F as S,a as v}from"./_components-AhTRSQH8.js";const u={description:"Advent of Code 2022 - Day 22: Monkey Map. Written in Haskell.",tags:["Grid walking","Geometry"],year:2022,day:22,title:"AoC 2022 D22: Monkey Map"};function w(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...m(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"AoC 2022 D22: Monkey Map"}),`
`,`
`,`
...
`,e.jsx(b,{code:(t,x,C,c,R)=>{const s={A:[2,0],B:[1,0],C:[1,1],D:[1,2],E:[0,2],F:[0,3]};t.translate(80/2,80/2),t.font="20px monospace",t.textAlign="center",t.textBaseline="middle";function g(o,r,d){o*=80,r*=80,t.strokeRect(o,r,80,80),t.fillStyle=c,t.fillText(d,o+80/2,r+80/2),t.fillStyle="teal",t.fillRect(o+4,r,80-2*4,4),t.fillStyle="goldenrod",t.fillRect(o+4,r+80-4,80-2*4,4),t.fillStyle="coral",t.fillRect(o,r+4,4,80-2*4),t.fillStyle="mediumorchid",t.fillRect(o+80-4,r+4,4,80-2*4),t.fillStyle=c}function a(o,r,d,j,h,l){t.beginPath();const p=s[o][0]+(r==="L"?0:r==="R"?1:.5),f=s[o][1]+(r==="T"?0:r==="B"?1:.5),y=s[h][0]+(l==="L"?0:l==="R"?1:.5),M=s[h][1]+(l==="T"?0:l==="B"?1:.5);t.moveTo(p*80,f*80),t.quadraticCurveTo((d+p)*80,(j+f)*80,y*80,M*80),t.stroke()}for(const[o,[r,d]]of Object.entries(s))g(r,d,o);a("C","L",-.5,0,"E","T"),a("C","R",.5,0,"A","B"),a("F","L",-1,-4,"B","T"),a("F","R",.5,0,"D","B"),a("F","B",3,-1,"A","T"),t.setLineDash([8,6]),a("B","L",-1.5,0,"E","L"),a("A","R",1,2,"D","R")},width:350,height:400}),`
...
moveStep board wraparound (r, c, dir) =
  ...
  where
    ...
    (r', c', _) = st''
`})}),`
`,e.jsx(v,{frontMatter:u})]})}function F(i={}){const{wrapper:n}={...m(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(w,{...i})}):w(i)}export{F as default,u as frontMatter};
