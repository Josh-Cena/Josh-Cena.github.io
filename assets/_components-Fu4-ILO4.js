import{j as a,L as t}from"./index-CKqa2xZ3.js";import{c as p}from"./index-Ciqn2WuZ.js";const m=`Year,Index,Mean ± Stdev,Median,Max,Median Solve %,Round
...
`).slice(1).map(n=>{const[A,i,N,o,I,r,v]=n.split(","),[c,d]=N.split(" ± ").map(h=>parseFloat(h));return{year:parseInt(A,10),index:i,mean:c,std:d,median:parseFloat(o),max:parseFloat(I),medianSolvePct:parseFloat(r.replace("%",""))/100,isOpen:v==="Open"}}),l=new Map;for(const n of x)l.set(`${n.year}${n.index}`,n);const u="_tag_1erk9_1",b="_paginator_1erk9_11",C="_yearIndex_1erk9_17",e={tag:u,paginator:b,yearIndex:C},g=p.scale(["#ca393e","#3eca39"]).domain([0,1]);function j({prob:n,alwaysSolid:A}){const i=l.get(n);if(!i||Number.isNaN(i.medianSolvePct))return"N/A";const N=g(i.medianSolvePct).hex();return a.jsxs("span",{style:{...i.isOpen||A?{backgroundColor:N,color:p(N).luminance()<.5?"white":"black"}:{border:`2px solid ${N}`,color:N},padding:"0.1em 0.4em",borderRadius:"var(--border-radius-small)",fontWeight:"bold",fontVariantNumeric:"tabular-nums"},title:`Median Solve Percentage: ${(i.medianSolvePct*100).toFixed(2)}%`,children:[(i.medianSolvePct*100).toFixed(2),"%"]})}function s(n){let A="A";for(const i of l.keys()){const N=/^(?<year>\d{4})(?<prob>[A-Z])$/u.exec(i);N?.groups?.year===n.toString()&&N.groups.prob>A&&(A=N.groups.prob)}return A}function O({frontMatter:n}){const A=n.prob.charCodeAt(0);return a.jsxs("nav",{className:e.paginator,children:[n.prob==="A"?a.jsx("span",{className:"phantom",children:"← Previous"}):a.jsx(t,{href:`/notes/naclo/${n.year}/${String.fromCharCode(A-1)}/`,children:"← Previous"})," ",a.jsx(t,{href:`/notes/naclo/${n.year}/`,children:"Back to year index"})," ",n.prob===s(n.year)?a.jsx("span",{className:"phantom",children:"→ Next"}):a.jsx(t,{href:`/notes/naclo/${n.year}/${String.fromCharCode(A+1)}/`,children:"Next →"})]})}function F({frontMatter:n}){const A=n.year===2024?`https://naclo.org/resources/problems/2024/NACLO2024ROUND${n.prob<="H"?"1":"2"}_booklet.pdf`:`https://naclo.org/resources/problems/${n.year}/N${n.year}-${n.prob}.pdf`,i=n.year===2024?`https://naclo.org/resources/problems/2024/NACLO2024ROUND${n.prob<="H"?"1":"2"}SOL.pdf`:`https://naclo.org/resources/problems/${n.year}/N${n.year}-${n.prob}S.pdf`,N=l.get(`${n.year}${n.prob}`);return a.jsxs(a.Fragment,{children:[a.jsxs("p",{children:[N?.isOpen?"Open round":"Invitational round"," | ",N?.max," points |"," ",a.jsx(j,{prob:`${n.year}${n.prob}`,alwaysSolid:!0})," ","| ",a.jsx(t,{href:A,children:"Problem statement"})," |"," ",a.jsx(t,{href:i,children:"Official solution"})," | Tags:"," ",n.tags.map(o=>a.jsx("span",{className:e.tag,children:o},o))]}),a.jsx(O,{frontMatter:n})]})}function D({frontMatter:n}){return a.jsx(O,{frontMatter:n})}function P({year:n}){return a.jsxs("nav",{className:e.paginator,children:[n===2022?a.jsx("span",{className:"phantom",children:"← Previous year"}):a.jsx(t,{href:`/notes/naclo/${n-1}/`,children:"← Previous year"})," ",a.jsx(t,{href:"/notes/naclo/",children:"Back to NACLO index"})," ",n===2026?a.jsx("span",{className:"phantom",children:"→ Next year"}):a.jsx(t,{href:`/notes/naclo/${n+1}/`,children:"→ Next year"})]})}function f({year:n}){return a.jsx("nav",{children:a.jsx("ul",{className:e.yearIndex,children:Array.from({length:s(n).charCodeAt(0)-65+1},(i,N)=>N).map(i=>a.jsx("li",{children:a.jsx(t,{href:`/notes/naclo/${n}/${String.fromCharCode(65+i)}/`,children:String.fromCharCode(65+i)})},i))})})}function y({year:n}){return a.jsxs(a.Fragment,{children:[a.jsxs("p",{children:["Problem statements:"," ",a.jsx(t,{href:`https://naclo.org/resources/problems/${n}/NACLO${n}ROUND1.pdf`,children:"Round 1"}),","," ",a.jsx(t,{href:`https://naclo.org/resources/problems/${n}/NACLO${n}ROUND2.pdf`,children:"Round 2"})," ","| Official solutions:"," ",a.jsx(t,{href:`https://naclo.org/resources/problems/${n}/NACLO${n}ROUND1SOL.pdf`,children:"Round 1"}),","," ",a.jsx(t,{href:`https://naclo.org/resources/problems/${n}/NACLO${n}ROUND2SOL.pdf`,children:"Round 2"})]}),a.jsx(P,{year:n}),a.jsx(f,{year:n})]})}function B({year:n}){return a.jsxs("nav",{className:e.paginator,children:[n===2022?a.jsx("span",{className:"phantom",children:"← Previous year"}):a.jsx(t,{href:`/notes/yale/naclo/${n-1}/`,children:"← Previous year"})," ",a.jsx(t,{href:"/notes/yale/naclo/",children:"Back to NACLO index"})," ",n===2025?a.jsx("span",{className:"phantom",children:"→ Next year"}):a.jsx(t,{href:`/notes/yale/naclo/${n+1}/`,children:"→ Next year"})]})}export{B as C,j as D,F as P,y as Y,D as a};
