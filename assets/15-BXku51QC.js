...
`,n.jsx(e.p,{children:"Part 1 already built the full map, so part 2 is just a BFS from the oxygen system to find the maximum distance to any reachable cell."}),n.jsx(a,{frontMatter:o})]})}function c(t={}){const{wrapper:e}={...r(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(i,{...t})}):i(t)}export{c as default,o as frontMatter};
