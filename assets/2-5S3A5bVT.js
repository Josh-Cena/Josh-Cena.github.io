...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-python",children:`if (password[ind_range[0] - 1] == char) != (password[ind_range[1] - 1] == char):
    total += 1
`})}),`
`,e.jsx(c,{frontMatter:o})]})}function i(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{i as default,o as frontMatter};
