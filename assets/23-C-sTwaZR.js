import{u as s,j as e}from"./index-CKqa2xZ3.js";import{P as r,a as i}from"./_components-Ci0FrSUn.js";import"./_commonjsHelpers-CqkleIqs.js";const t={tags:["Dijkstra"],title:"Advent of Code 2021 - Day 23: Amphipod",description:"Advent of Code 2021 - Day 23: Amphipod, a problem that involves Dijkstra. Solution written in TypeScript, with detailed walkthrough and proof.",year:2021,day:23};function a(n){const o={a:"a",code:"code",h1:"h1",p:"p",pre:"pre",span:"span",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(o.h1,{children:["Advent of Code 2021 - Day 23",e.jsx(o.span,{className:"subtitle",children:"Amphipod"})]}),e.jsx(r,{frontMatter:t}),`
...
`})}),`
`,e.jsx(o.p,{children:"Part 2 just requires changing the initial rooms to insert the extra amphipods."}),e.jsx(i,{frontMatter:t})]})}function d(n={}){const{wrapper:o}={...s(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(a,{...n})}):a(n)}export{d as default,t as frontMatter};
