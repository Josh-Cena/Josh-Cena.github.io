...
`})}),`
`,(0,i.jsx)(a.p,{children:`To find the destination cup efficiently, we can maintain a mapping from label to cup nodes, in addition to the linked list itself.`}),`
`,(0,i.jsx)(a.pre,{children:(0,i.jsx)(a.code,{className:`language-python`,children:`tail = Cup(nums[-1])
...
cur_cup = head
`})}),`
`,(0,i.jsx)(a.p,{children:`Now we can faithfully implement the rules. Code is self-explanatory. The only potentially messy part is the splicing of the picked cups out of the list and into their new position.`}),`
`,(0,i.jsx)(a.pre,{children:(0,i.jsx)(a.code,{className:`language-python`,children:`cur_cup = head
...
`})}),(0,i.jsx)(r,{frontMatter:e})]})}function o(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,i.jsx)(n,{...e,children:(0,i.jsx)(a,{...e})}):a(e)}o.meta={tags:[`Data structures`],title:`Advent of Code 2020 - Day 23: Crab Cups`,description:`Advent of Code 2020 - Day 23: Crab Cups, a problem that involves Data structures. Solution written in Python, with detailed walkthrough and proof.`,year:2020,day:23};export{o as default};