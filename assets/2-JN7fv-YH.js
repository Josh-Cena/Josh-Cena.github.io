...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-python",children:`if (password[ind_range[0] - 1] == char) != (password[ind_range[1] - 1] == char):
    total += 1
`})}),`
`,e.jsx(c,{frontMatter:t})]})}function i(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{i as default,t as frontMatter};
