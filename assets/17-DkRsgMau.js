...
`})}),`
`,e.jsxs(n.p,{children:["Because the maximum number of steps is bigger, the graph is also bigger because we have more states. I pass ",e.jsx(n.code,{children:"neighbors"})," and ",e.jsx(n.code,{children:"max_steps"})," as arguments to ",e.jsx(n.code,{children:"dijkstra"})," so that I can reuse the same function. It runs for 5 seconds."]}),e.jsx(o,{frontMatter:s})]})}function l(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{l as default,s as frontMatter};
